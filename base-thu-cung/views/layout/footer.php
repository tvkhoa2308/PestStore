                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i> Cao đẳng FPT Polytechnic</li>
                                        <li><i class="pe-7s-mail"></i> <a href="#">khoatvph51572@gmail.com </a></li>
                                        <li><i class="pe-7s-call"></i> <a href="#">0899550805</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2024 <b>THU CUNG FPL</b> Made with <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/"><b>Văn Khoa</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
