                  ...
                  <?php foreach ($listSanPham as $key => $sanPham) : ?>
                    ...
                    <tr>
                      ...
                      <a href="<?= BASE_URL_ADMIN .'?act=form-sua-san-pham&id_san_pham=' . $sanPham['id'] ?>">
                         <button class="btn btn-warning"><i class="fa fa-wrench"></i></button>
                      </a>
                       <a href="<?= BASE_URL_ADMIN .'?act=xoa-san-pham&id_san_pham=' . $sanPham['id'] ?>" onclick="return confirm('Bạn muốn xóa nó không?')"> <button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
